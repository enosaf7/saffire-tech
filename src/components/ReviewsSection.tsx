...
// This data will be used as initial fallback if fetch fails or as placeholder during loading
  ...
  return (
    <section className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {isLoading ? (
            ...
            Array(limit).fill(0).map((_, index) => (
              <div key={index} className="bg-secondary rounded-lg p-6 shadow-inner">
        ...
        {showViewAllButton && allReviews.length > limit && (
